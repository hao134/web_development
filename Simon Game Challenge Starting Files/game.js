...
//1.Use JQuery to detect when a keyboard key has been pressed, when that happens for the first time,
// call nextSequence().
$(document).keypress(function() {
    if(!started) {
        //3. The h1 title starts out saying "Press A key to Start", when the game has started,
